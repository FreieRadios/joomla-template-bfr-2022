...
if ($paramsFontScheme)
{
	if (stripos($paramsFontScheme, 'https://') === 0)
	{
		...
		{
			$fontStyles = '--bfr-2022-font-family-body: "' . str_replace('+', ' ', $matches[1][0]) . '", sans-serif;
			--bfr-2022-font-family-headings: "' . str_replace('+', ' ', isset($matches[1][1]) ? $matches[1][1] : $matches[1][0]) . '", sans-serif;
			--bfr-2022-font-weight-normal: 400;
			--bfr-2022-font-weight-headings: 700;';
		}
	}
	else
	{
...
?>">
	...
	<?php if ($this->params->get('backTop') == 1) : ?>
		<a href="#top" id="back-top" class="back-to-top-link" aria-label="<?php echo Text::_('TPL_bfr-2022_BACKTOTOP'); ?>">
